/*
* Class: CS2A
* Description: Compute and print out five expressions based 
* on the number of letters in your first name, and your 
* student ID.
...
int main()
{
	...
	cout << "The number of characters in my first name is " 
		<< numLet << endl << endl;
	...
	cout << "Expression 3: " 
		<< setprecision(20) << fixed << doubleResult << endl;
	// expression 4
	intResult = 1 + 2 + 3 + 4 + 5;
	cout << "Expression 4: " << intResult << endl;
	// expression 5
	doubleResult = (15000.0) / (80.0 + ((myId - 123456.0) 
		/ ((numLet + 20.0) * (numLet + 20.0))));
	cout << "Expression 5: " 
		<< setprecision(20) << fixed << doubleResult << endl;
